...
CREATE TABLE `pms_product` (
  ...
  `sale_channel_code` varchar(16) DEFAULT NULL COMMENT '销售渠道代码(TXS:唐小僧, YW:摇旺, QYLC:企业理财, ZD:资鼎，QJS:乔金所)',
  ...
  `collect_status` tinyint(2) DEFAULT NULL COMMENT '产品募集状态(10:待募集，11:募集期，12:待成立，13:已成立，14:存续期，15:到期，16:待兑付，17:兑付完成, 18:流标, 19:兑付中, 20:逾期)',
...
) ENGINE=InnoDB AUTO_INCREMENT=298 DEFAULT CHARSET=utf8 COMMENT='产品主信息表';
...
) ENGINE=InnoDB AUTO_INCREMENT=360 DEFAULT CHARSET=utf8 COMMENT='产品审核信息表';
...
CREATE TABLE `pms_product_contract` (
  ...
  KEY `idx_product_id` (`product_id`) USING BTREE,
  KEY `idx_product_code` (`product_code`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=316 DEFAULT CHARSET=utf8 COMMENT='产品合同信息表';
...
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='产品线信息表';
...
CREATE TABLE `pms_product_period` (
  ...
  KEY `idx_product_id` (`product_id`) USING BTREE,
  KEY `idx_product_code` (`product_code`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=250 DEFAULT CHARSET=utf8 COMMENT='产品期限信息表';
...
CREATE TABLE `pms_product_profit` (
  ...
  KEY `idx_product_id` (`product_id`) USING BTREE,
  KEY `idx_product_code` (`product_code`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=229 DEFAULT CHARSET=utf8 COMMENT='产品投资收益信息表';
...
CREATE TABLE `pms_product_stock` (
  ...
  KEY `idx_product_id` (`product_id`) USING BTREE,
  KEY `idx_product_code` (`product_code`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=297 DEFAULT CHARSET=utf8 COMMENT='产品库存信息表';
...
) ENGINE=InnoDB AUTO_INCREMENT=405 DEFAULT CHARSET=utf8 COMMENT='产品库存变更流水表';
...
) ENGINE=InnoDB AUTO_INCREMENT=579 DEFAULT CHARSET=utf8 COMMENT='产品库存变更请求表';
...
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8 COMMENT='产品序列信息表';
