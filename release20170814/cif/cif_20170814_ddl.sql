...
CREATE TABLE `enterprise_account` (
  ...
  `account_type` tinyint(1) NOT NULL COMMENT '账户类型 1:虚拟账户 2：电子账户',
  `account_purpose` tinyint(1) NOT NULL COMMENT '账户用途',
...
CREATE TABLE `enterprise_bind_card` (
  ...
  `reserve_mobile` varchar(11) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '预留手机号',
...
/*Table structure for table `enterprise_bind_card_history` */

DROP TABLE IF EXISTS `enterprise_bind_card_history`;

CREATE TABLE `enterprise_bind_card_history` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `member_id` varchar(32) COLLATE utf8_unicode_ci NOT NULL COMMENT 'member_id',
  `band_id` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '绑定Id',
  `bind_time` datetime DEFAULT NULL COMMENT '绑定时间',
...
) ENGINE=InnoDB AUTO_INCREMENT=38 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='企业信息表';
...
CREATE TABLE `enterprise_member` (
  ...
  `customer_id` varchar(64) COLLATE utf8_unicode_ci NOT NULL COMMENT '客户ID',
  `trans_flag` tinyint(1) DEFAULT NULL COMMENT '机构间转账标识 1：开启 0：关闭',
  `auth_amt` decimal(12,2) DEFAULT NULL COMMENT '授权金额',
  `trade_pwd` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '交易密码',
  `status` tinyint(1) DEFAULT NULL COMMENT '状态：0：开户中 1：开户成功 2：开户失败',
  `grade` varchar(8) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '会员等级',
  `trd_cust_id` varchar(64) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '第三方客户号',
...
) ENGINE=InnoDB AUTO_INCREMENT=38 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='企业会员表';
...
/*Table structure for table `person_bind_card_history` */

DROP TABLE IF EXISTS `person_bind_card_history`;

CREATE TABLE `person_bind_card_history` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `member_id` varchar(32) COLLATE utf8_unicode_ci NOT NULL COMMENT 'member_id',
  `band_id` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '绑定Id',
  `bind_time` datetime DEFAULT NULL COMMENT '绑定时间',
...
CREATE TABLE `person_info` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `index_customer_id` (`customer_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=44 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='个人会员信息表';
...
CREATE TABLE `person_member` (
  ...
  `user_name` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '别名',
  ...
  `status` tinyint(1) DEFAULT NULL COMMENT '状态：0：待激活；1:已实名认证 2：开户中 3：激活中 5：开户成功 4：开户失败',
  `trans_free_flag` tinyint(1) DEFAULT NULL COMMENT '免密开启标识 1：已开启 0：未开启',
  `user_cust_id` varchar(64) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '第三方客户号',
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `index_member_id` (`member_id`) USING BTREE,
  UNIQUE KEY `index_out_member_id_source` (`out_member_id`,`source`)
) ENGINE=InnoDB AUTO_INCREMENT=55 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='个人会员表';
