...
alter table ams_asset_repay_plan add loan_fee decimal(16,4) DEFAULT '0.0000' comment '手续费' after loan_cert_no;
...
INSERT INTO `ams_finance_subject` (`subject_code`,	`subject_name`,	`subject_show_name`,`cert_type`,`cert_no`,`cert_no_show_name`,
`registered_capital`,`subject_address`,`subject_address_show_name`,`legal_person_name`,`legal_person_cert_no`,`business_scope`,`tel`,`email`,`introduction`)
VALUES ('MSD','马上贷','马上贷','2','91330110MA28L7MA35','','1000.0000','上海市三林镇','上海市','王春燕','341022197703101326',
'投资管理、资产管理、实业投资、投资咨询；企业管理咨询，公共关系咨询，商务信息咨询，经济信息咨询。',	'',	'',	'');