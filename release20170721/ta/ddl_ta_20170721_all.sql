...
CREATE TABLE `ladder_account_info` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `certTypeAndNo` (`cert_type`,`cert_no`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=0 DEFAULT CHARSET=utf8 COMMENT='用户交易账户表';
...
CREATE TABLE `ladder_batch` (
  ...
  `status` varchar(32) DEFAULT NULL COMMENT 'INIT:初始化,COMPLETE:处理完成,PROCESS_FAIL:处理异常,DATA_SUCCESS:数据处理完成；PROCESSING：处理中；CONFIRM_SUCCESS：已确认；ASSET_SUCCESS：资产匹配完成；FILE_UPLOADING：文件上传中；UPLOAD_COMPLETE：文件上传完成；',
  `thirdparty_batch_no` varchar(64) DEFAULT NULL COMMENT '交易系统文件批次号',
  `batch_no` char(64) DEFAULT NULL COMMENT '批次号',
...
CREATE TABLE `ladder_invest_record` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=0 DEFAULT CHARSET=utf8 COMMENT='用户投资记录表';
-- ----------------------------
...
CREATE TABLE `ladder_product` (
  ...
  `floating_yield_rate` decimal(12,8) DEFAULT NULL COMMENT '浮动收益率',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=0 DEFAULT CHARSET=utf8 COMMENT='产品登记表';
-- ----------------------------
...
CREATE TABLE `ladder_product_asset` (
  ...
  `asset_type` varchar(8) DEFAULT NULL COMMENT '融资类型1:小贷收益权,2:应收账款收益权,3:定向融资工具',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=0 DEFAULT CHARSET=utf8 COMMENT='产品-资产登记表';
-- ----------------------------
...
CREATE TABLE `ladder_product_ladder` (
  ...
  `poundage` decimal(12,8) DEFAULT NULL COMMENT '扣减手续费率',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=0 DEFAULT CHARSET=utf8;
-- ----------------------------
-- Table structure for ladder_redeem_income
-- ----------------------------
DROP TABLE IF EXISTS `ladder_redeem_income`;
...
) ENGINE=InnoDB AUTO_INCREMENT=0 DEFAULT CHARSET=utf8 COMMENT='TA系统序列表';
-- ----------------------------
...
CREATE TABLE `ladder_stage_income_plan` (
  ...
  KEY `idx__stage_date` (`stage_begin_date`,`stage_end_date`),
  KEY `idx_income_date` (`income_process_date`)
) ENGINE=InnoDB AUTO_INCREMENT=0 DEFAULT CHARSET=utf8;
...
CREATE TABLE `ladder_trade_account_info` (
  ...
  `modify_by` varchar(64) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `accountAndSalAndProduct` (`ta_account_no`,`sale_channel`,`product_code`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=0 DEFAULT CHARSET=utf8;
-- ----------------------------
...
CREATE TABLE `ladder_trade_account_transaction` (
  ...
  `ref_type` varchar(40) DEFAULT NULL COMMENT '变动表名',
  `ref_id` bigint(20) DEFAULT NULL COMMENT '变动表ID',
  `create_time` datetime DEFAULT NULL,
  `create_by` varchar(64) DEFAULT NULL,
  `modify_time` datetime DEFAULT NULL,
  `modify_by` varchar(64) DEFAULT NULL,
