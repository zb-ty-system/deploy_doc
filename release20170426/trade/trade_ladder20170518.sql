...
CREATE TABLE `ladder_account_transaction` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=120 DEFAULT CHARSET=utf8 COMMENT='账户变动记录表';
...
) ENGINE=InnoDB AUTO_INCREMENT=429 DEFAULT CHARSET=utf8 COMMENT='批次记录表';
...
CREATE TABLE `ladder_daily_income` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
  `batch_no` varchar(64) DEFAULT NULL COMMENT '批次号',
  `app_sheet_no` varchar(64) DEFAULT NULL COMMENT 'ta系统流水号',
...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='每日收益记录表';
...
CREATE TABLE `ladder_invest_confirm` (
  ...
  `origin_trade_serial_no` varchar(64) DEFAULT NULL,
  `batch_no` varchar(64) DEFAULT NULL COMMENT '批次号',
  `platform_member_id` varchar(64) DEFAULT NULL COMMENT '平台会员ID',
...
) ENGINE=InnoDB AUTO_INCREMENT=55 DEFAULT CHARSET=utf8 COMMENT='投资确认记录表';
...
CREATE TABLE `ladder_invest_request` (
  ...
  KEY `platformMemberId_index` (`platform_member_id`),
  KEY `productCode_index` (`product_code`)
) ENGINE=InnoDB AUTO_INCREMENT=71 DEFAULT CHARSET=utf8 COMMENT='投资申请记录表';
...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='赎回确认记录表';
...
) ENGINE=InnoDB AUTO_INCREMENT=100 DEFAULT CHARSET=utf8 COMMENT='赎回申请记录表';
...
) ENGINE=InnoDB AUTO_INCREMENT=29 DEFAULT CHARSET=utf8 COMMENT='交易系统序列表';
...
CREATE TABLE `ladder_stage_income_plan` (
  ...
  PRIMARY KEY (`id`),
  KEY `appSheetNo_index` (`app_sheet_no`)
) ENGINE=InnoDB AUTO_INCREMENT=74 DEFAULT CHARSET=utf8 COMMENT='还款计划记录表';
...
) ENGINE=InnoDB AUTO_INCREMENT=766 DEFAULT CHARSET=utf8 COMMENT='账户表';
