...
CREATE TABLE `pms_product` (
  ...
  `join_channel_code` varchar(32) DEFAULT NULL COMMENT '接入渠道(01:资邦定期)',
...
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='产品主信息表';
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='产品审核信息表';
...
CREATE TABLE `pms_product_contract` (
  ...
  KEY `idx_product_id` (`product_id`) USING BTREE,
  KEY `idx_product_code` (`product_code`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8 COMMENT='产品合同信息表';
...
CREATE TABLE `pms_product_ladder` (
  ...
  KEY `idx_product_id` (`product_id`) USING BTREE,
  KEY `idx_product_code` (`product_code`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8 COMMENT='产品阶梯信息表';
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='产品线信息表';
...
CREATE TABLE `pms_product_period` (
  ...
  KEY `idx_product_id` (`product_id`) USING BTREE,
  KEY `idx_product_code` (`product_code`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COMMENT='产品期限信息表';
...
CREATE TABLE `pms_product_profit` (
  ...
  `loop_increase_yield_rate` decimal(12,8) DEFAULT '0.00000000' COMMENT '收益递增系数',
  ...
  KEY `idx_product_id` (`product_id`) USING BTREE,
  KEY `idx_product_code` (`product_code`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COMMENT='产品投资收益信息表';
...
CREATE TABLE `pms_product_stock` (
  ...
  KEY `idx_product_id` (`product_id`) USING BTREE,
  KEY `idx_product_code` (`product_code`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='产品库存信息表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='产品库存变更流水表';
...
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8 COMMENT='产品库存变更请求表';
...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='产品序列信息表';
