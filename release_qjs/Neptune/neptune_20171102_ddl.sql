...
) ENGINE=InnoDB AUTO_INCREMENT=5614 DEFAULT CHARSET=utf8 COMMENT='投资人兑付表';
...
) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=utf8 COMMENT='合同';
...
CREATE TABLE `invest` (
  ...
  `modify_time` timestamp(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) ON UPDATE CURRENT_TIMESTAMP(3),
  `modify_by` varchar(64) NOT NULL DEFAULT 'system',
  `investor_bank_account_name` varchar(64) NOT NULL DEFAULT '' COMMENT '投资人银行账户户名',
  `investor_opening_bank` varchar(128) NOT NULL DEFAULT '' COMMENT '投资人银行账户开户行',
  `investor_bank_card_no` varchar(64) NOT NULL DEFAULT '' COMMENT '投资人银行账号',
  `sign_id` varchar(64) NOT NULL DEFAULT '' COMMENT '投资人签约协议号',
...
) ENGINE=InnoDB AUTO_INCREMENT=92 DEFAULT CHARSET=utf8 COMMENT='投资表';
...
) ENGINE=InnoDB AUTO_INCREMENT=8688 DEFAULT CHARSET=utf8 COMMENT='接口请求重试表';
...
) ENGINE=InnoDB AUTO_INCREMENT=97 DEFAULT CHARSET=utf8 COMMENT='产品';
