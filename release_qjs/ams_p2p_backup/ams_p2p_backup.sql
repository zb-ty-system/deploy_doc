...
CREATE TABLE `ams_asset` (
  ...
  `register_type` tinyint(2) DEFAULT '1' COMMENT '注册类型：1-普通录入,2-授信录入,3-交易所录入',
...
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='资产信息表';
...
CREATE TABLE `ams_asset_approval` (
  ...
  KEY `idx_asset_code` (`asset_code`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='资产审核信息表';
...
CREATE TABLE `ams_asset_exchange_register` (
  ...
  `modify_by` varchar(32) DEFAULT 'SYS' COMMENT '最后更新者',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='资产备案信息表';
...
CREATE TABLE `ams_asset_issue_relation` (
  ...
  `modify_by` varchar(32) DEFAULT 'SYS' COMMENT '最后更新者',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='资产和发行计划关联关系表';
...
CREATE TABLE `ams_asset_pool_relation` (
  ...
  KEY `idx_asset_id` (`asset_id`) USING BTREE,
  KEY `idx_asset_code` (`asset_code`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='资产与资产池关联信息表';
...
CREATE TABLE `ams_asset_product_relation` (
  ...
  KEY `idx_asset_id` (`asset_id`) USING BTREE,
  KEY `idx_asset_code` (`asset_code`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='产品资产匹配关系表';
...
CREATE TABLE `ams_asset_repay_plan` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='资产还款计划表';
...
CREATE TABLE `ams_business_credit` (
  ...
  `modify_by` varchar(32) DEFAULT 'SYS' COMMENT '最后更新者',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='业务授信表';
...
CREATE TABLE `ams_exchange` (
  ...
  KEY `idx_cert_no` (`cert_no`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='交易所信息表';
...
CREATE TABLE `ams_file_template_param` (
  ...
  `modify_by` varchar(32) DEFAULT 'SYS' COMMENT '最后更新者',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='文件模板参数';
...
CREATE TABLE `ams_finance_subject` (
  ...
  KEY `idx_cert_no` (`cert_no`) USING BTREE,
  KEY `idx_legal_person_cert_no` (`legal_person_cert_no`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='发行方信息表';
...
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='资管系统全局参数表';
...
CREATE TABLE `ams_issue_plan` (
  ...
  `modify_by` varchar(32) DEFAULT 'SYS' COMMENT '最后更新者',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='资产发行计划';
...
CREATE TABLE `ams_pool` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_pool_code` (`pool_code`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='资产池信息表';
...
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='资产相关序列表';
...
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='受托方信息表';
